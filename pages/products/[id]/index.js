      ...
      <div className="max-w-screen-xl mx-auto">
        <div className="p-6 flex justify-center items-center" style={{ height: "calc(100vh - (68px + 72px))" }}>
          <div className="shadow-lg rounded-3xl w-4/5 overflow-hidden flex relative">
            {item?.offer && (
              <div className="bg-blue-200 px-6 py-2 rounded-s-md absolute top-10 right-0">Oferta del {item?.offer}</div>
            )}
            ...
            <div className="p-8">
              ...
              <p className="text-5xl font-bold text-green-500 mt-6">{item?.price}</p>
              <p className="mt-6">
